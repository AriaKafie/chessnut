...
namespace Chess {
	...
	movegen::movegen(bool generate_enpassant_) : generate_enpassant(generate_enpassant_) {
	...
	bool movegen::is_attacked(uint64_t squares) {
	...
	uint64_t movegen::squares_controlled_by_black() {
