...
extern Bitboard double_check[];
extern Bitboard bishop_xray[];
extern Bitboard rook_xray[];
extern int rook_hash[];
extern int bishop_hash[];
extern Bitboard rook_masks[];
extern Bitboard rook_attacks[];
extern Bitboard bishop_masks[];
extern Bitboard bishop_attacks[];
extern Bitboard knight_attacks[];
extern Bitboard king_attacks[];
extern Bitboard check_ray[SQUARE_NB][SQUARE_NB];
extern Bitboard pin_mask[SQUARE_NB][SQUARE_NB];
extern Bitboard pawn_attacks[COLOR_NB][SQUARE_NB];
extern Bitboard file[SQUARE_NB];
extern Bitboard f_diagonal[SQUARE_NB];
extern Bitboard b_diagonal[SQUARE_NB];
extern uint8_t square_distance[SQUARE_NB][SQUARE_NB];
extern uint8_t distance_from_center[SQUARE_NB];
extern uint8_t castling_pext[];
extern Bitboard white_kingshield[];
extern Bitboard black_kingshield[];
extern int white_kingshield_scores[SQUARE_NB][1 << 6];
extern int black_kingshield_scores[SQUARE_NB][1 << 6];
